...
public class ManagerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
       ...
       HttpServletRequest req = (HttpServletRequest) request;
        ...
        // Lấy thông tin người dùng (đã được đảm bảo bởi AuthenticationFilter)
        UserDTO user = (UserDTO) session.getAttribute("loggedUser");
        
        String userRole = user.getRoleID();
        
        if(!userRole.equals("ADM") && !userRole.equals("MNG")){
            req.setAttribute("errorMessage", "403 - Truy cập bị Từ chối! "
                    + "Yêu cầu quyền: ADM hoac MNG" );
